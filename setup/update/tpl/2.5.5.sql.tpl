...
{foreach $locales as $locale}
    (@max_id + 1, '{$locale}', {intl l='Rounding mode for calculating the order total (1: sums of roundings, 2: rounding of sums).' locale=$locale}, NULL, NULL, NULL){if ! $locale@last},{/if}
{/foreach}
